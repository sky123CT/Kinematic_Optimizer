...
movement_W = DM(np.diag([1]*robot_joint_num))
max_velocity_W = DM(np.diag([1/1000.0]*robot_joint_num))
input_W = DM(np.diag([0] * robot_joint_num))
...
if without_T:
    from optimizer import DirectCollocationWT as DirectCollocation
